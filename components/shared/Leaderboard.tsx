      ...
      <div className="flex rounded-xl bg-card p-1">
        <button
          ...
          className={`flex-1 rounded-lg px-4 py-2 text-sm font-medium transition-colors ${
            tab === 'individual' ? 'bg-accent text-white' : 'text-muted hover:text-foreground'
          }`}
        >
          Individual
        </button>
        <button
          ...
          className={`flex-1 rounded-lg px-4 py-2 text-sm font-medium transition-colors ${
            tab === 'teams' ? 'bg-accent text-white' : 'text-muted hover:text-foreground'
          }`}
        >
          Teams
        </button>
...
function PodiumItem({
  ...
  return (
    <div
      className="flex w-24 flex-col items-center gap-1 animate-slide-up"
      style={{ animationDelay: `${(place - 1) * 100}ms` }}
    >
